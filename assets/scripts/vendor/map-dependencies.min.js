...
return function(point,i){i||(x0=y0=0);var x1=(point[0]-dx)/kx|0,y1=(point[1]-dy)/ky|0;point[0]=x1-x0,point[1]=y1-y0,x0=x1,y0=y1}}function noop(){}var topojson={version:"1.6.15",mesh:function(topology){return object(topology,meshArcs.apply(this,arguments))},meshArcs:meshArcs,merge:function(topology){return object(topology,mergeArcs.apply(this,arguments))},mergeArcs:mergeArcs,feature:featureOrCollection,neighbors:neighbors,presimplify:presimplify};"function"==typeof define&&define.amd?define(topojson):"object"==typeof module&&module.exports?module.exports=topojson:this.topojson=topojson}();