$(document).ready(function() {
  ...
  // For some reason, sometimes the value of site-header's outer-height
  // is not correct. This is probably because of a render delay.
  // Defer the request so to have everything loaded.
  setTimeout(function() {
