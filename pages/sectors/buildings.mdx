export const metaData = {
  ...
  description:
    "Description text for each of the sectors to appear under the title in the banner",
  order: 3,
}

import SectorPage from "@layouts/SectorPage"
...
<SectorPageBanner
  findings={[
    ...
    {
      title: "25%",
      description: "Drop in share of heating from coal in residential heating mix",
    },
    {
      title: "39%",
