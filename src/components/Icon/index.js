...
export const TwitterIcon = (props) => {
  return (
    <Icon {...props} fill="currentcolor" stroke="none">
      <path d="M13.969 10.157L22.707 0h-2.07l-7.588 8.82L6.99 0H0l9.164 13.336L0 23.988h2.07l8.013-9.314 6.4 9.314h6.989l-9.503-13.83zM2.817 1.56h3.18l14.64 20.94h-3.18L2.817 1.56z" />
    </Icon>
  )
}
