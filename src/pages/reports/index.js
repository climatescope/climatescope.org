...
import { DownloadIcon, ExternalLinkIcon } from "@/components/Icon"
...
const climatescopeIssues = [
  ...
  {
    title: "Power transition factbook 2023",
    year: 2023,
    slug: "climatescope-2023-report.pdf",
    model: "CS2021_Model.xlsm",
    imgSrc: "climatescope-2023-report-en-cover.jpg",
    url: "https://2023.global-climatescope.org/",
  },
]
                        ...
                        <Stack direction={["column", null, "row"]}>
                          ...
                          {issue.year >= 2014 ? (
                            <ButtonLink
                              href={issue.url}
                              colorScheme="gray"
                              rightIcon={<ExternalLinkIcon size={5} />}
                            >
                              {"Website"}
                            </ButtonLink>
                          ) : null}
