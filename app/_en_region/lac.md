...
Last year, Mexico ($4.1bn) and Chile ($3.4bn) were the second and third largest renewable investment destinations (Figure 5). Much smaller countries have gone through waves of investment given the size of their economies and power grids. For instance, Honduras saw a surge of $675m invested last year and Jamaica received $205m for renewable energy projects, compared to only $3m in 2014. These countries will be unable to sustain such levels of investment on a yearly basis, but their successes in 2015 demonstrate how the clean energy map has expanded.  
