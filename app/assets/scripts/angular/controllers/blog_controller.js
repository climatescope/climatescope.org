(function() {
  var app = angular.module('blogApp', ['ngRoute', 'ui.bootstrap'], function($interpolateProvider) {
    $interpolateProvider.startSymbol('%%');
    $interpolateProvider.endSymbol('%%');
  });

  app.controller('blogController', ['$http', '$filter', '$rootScope', '$scope', '$location',
  function($http, $filter, $rootScope, $scope, $location) {
    ...
    $http.get(CS.domain + '/' + CS.lang + '/api/blog_posts.json').success(function(data) {
      _allPosts = data;
