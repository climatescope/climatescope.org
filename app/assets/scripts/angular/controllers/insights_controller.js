(function() {
  var app = angular.module('insightsApp', ['ngRoute', 'ui.bootstrap'], function($interpolateProvider) {
    $interpolateProvider.startSymbol('%%');
    $interpolateProvider.endSymbol('%%');
  });

  app.controller('insightsController', ['$http', '$filter', '$rootScope', '$scope', '$location',
  function($http, $filter, $rootScope, $scope, $location) {
    ...
    $http.get(CS.domain + '/' + CS.lang + '/api/insights_posts.json').success(function(data) {
      _allPosts = data;
